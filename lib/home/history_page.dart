  ...
  Widget _bg() => Stack(
    children: [
      Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [Color(0xffFFFFFF), Color(0xffF7FAFC), Color(0xffEEF3F8)],
          ),
        ),
      ),
      ...
      Positioned(
        ...
        child: _glow(
          size: 340,
          color: const Color(0xff00C853).withOpacity(.08),
        ),
      ),

      Positioned.fill(
        child: CustomPaint(
          painter: _GridPainter(lineColor: const Color(0xffDDE5EF)),
        ),
      ),
    ],
  );
              ...
              ShaderMask(
                shaderCallback: (bounds) {
                  return const LinearGradient(
                    colors: [Color(0xff111827), Color(0xff00C853)],
                  ).createShader(bounds);
                },
                child: const Text(
                  "Video History",
          ...
          children: [
            ...
            GestureDetector(
              onTap: () async {
                ...
                AdHelper.showInterstitial(() async {
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      color: const Color(0xff00E676).withOpacity(.3),
                      blurRadius: 24,
                      offset: const Offset(0, 10),
                    ),
                  ],
